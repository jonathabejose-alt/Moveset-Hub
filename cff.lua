...
local function Setup(char)
    ...
    buttons.skill1.Base.ToolName.Text = "Dribble"
    buttons.skill2.Base.ToolName.Text = "Trap Shot"
    buttons.skill3.Base.ToolName.Text = "Riptide"
    buttons.skill4.Base.ToolName.Text = "Intercept"
    buttons.skill5.Base.ToolName.Text = "Nutmeg Steal"

    buttons.skill1.Base.Reuse.Text = "Ball"
    buttons.skill2.Base.Reuse.Text = "Shot"
    buttons.skill3.Base.Reuse.Text = "Shot"
    buttons.skill4.Base.Reuse.Text = "Defense"
